...
const budgetCheckInHeadline = document.getElementById("budgetCheckInHeadline");
const budgetCheckInDetail = document.getElementById("budgetCheckInDetail");
const budgetStreakCount = document.getElementById("budgetStreakCount");
const nextBudgetCheckIn = document.getElementById("nextBudgetCheckIn");
const budgetCheckInButton = document.getElementById("budgetCheckInButton");
...
function renderBudgetCheckIn() {
  ...
  budgetCheckInHeadline.textContent = status.headline;
  budgetCheckInDetail.textContent = status.detail;
  budgetStreakCount.textContent = `${status.currentStreak}`;
  nextBudgetCheckIn.textContent = status.nextCheckInDate;
  budgetCheckInButton.textContent = status.buttonLabel;
  budgetCheckInButton.disabled = status.checkedInToday;
}
